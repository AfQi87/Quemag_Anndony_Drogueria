...
<div class="container">
  <form action="{{url('categoria/buscar')}}" method="POST">
    ...
    <div class="input-group mb-3">
      <a href="{{url('marca/formmarca')}}" class="btn-registrar btn btn-info">Registrar</a>
    </div>
  </form>
</div>
  ...
  <table id="example" class="table table-bordered table-hover">
    ...
    <tbody class="table-info">
      ...
      <tr>
        ...
        <td> <a href="{{route('actualizarMarc', $p->idmarca)}}" class="btn btn-success">
          ...
          @else
          <a href="{{route('eliminarMarca', $p->idmarca)}}" class="btn btn-danger" onclick="return desactivar()">

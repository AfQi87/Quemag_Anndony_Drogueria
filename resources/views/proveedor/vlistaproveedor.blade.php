...
<div class="container">
  <form action="{{url('proveedor/buscar')}}" method="POST">
    ...
    <div class="input-group mb-3">
      <a href="{{url('proveedor/formregistro')}}" class="btn-registrar btn btn-info">Registrar</a>
    </div>
  </form>
</div>
<div class="container">
  <table id="example" class="table table-bordered table-hover">
    ...
    <tbody class="table-info">
      ...
      <tr>
        ...
        <td> <a href="{{route('actualizarProve', $p->Idproveedor)}}" class="btn btn-success">
          ...
          @else
          <a href="{{route('eliminarProve', $p->Idproveedor)}}" class="btn btn-danger" onclick="return desactivar()">

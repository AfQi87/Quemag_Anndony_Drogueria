...
<div class="container">
  <form action="{{url('categoria/buscar')}}" method="POST">
    ...
    <div class="input-group mb-3">
      <a href="{{url('categoria/formcategoria')}}" class="btn-registrar btn btn-info">Registrar</a>
  ...
  <table id="example" class="table table-bordered table-hover">
    ...
    <tbody class="table-info">
      ...
      <tr>
        ...
        <td> <a href="{{route('actualizarCat', $p->Idcategoria)}}" class="btn btn-success">
          ...
          @else
          <a href="{{route('eliminarCategoria', $p->Idcategoria)}}" class="btn btn-danger" onclick="return desactivar()">
